    ...
    <Modal
      ...
      <div>
        ...
        <Upload
          ...
          action="https://www.juniwota.com/gather/files/upload">
  ...
  export default {
    ...
    created() {
      this.$nextTick(() => {
        ...
        this.editor.ready(() => {
          ...
          $('#' + this.editor.ui.toolbars[0].id).addClass('edui-toolbar-primary')
          $('#' + this.editor.ui.toolbars[1].id).addClass('edui-toobar-secondary')
    ...
    methods: {
      ...
      successFile(response){
        ...
        this.editor.execCommand('inserthtml','<img src="'+(process.env.NODE_ENV === 'production' ? response.msg : process.env.API + response.msg)+'" />')
      }
    }
  }
</script>
